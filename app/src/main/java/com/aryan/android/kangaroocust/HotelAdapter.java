        ...
        holder.favouriteSymbol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mFavouriteImages.get(position) == R.drawable.ic_favorite_white_24dp) {
                    ...
                    Firebase favouritesReference = new Firebase("https://kangaroorooms-288e3.firebaseio.com/Users/" + FirstRunSecondActivity.userUid + "/Favourites" );
                    ...
                    DatabaseReference favourites = FirebaseDatabase.getInstance().getReference("Users/" + FirstRunSecondActivity.userUid + "/Favourites");
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                if (snapshot.child("VehicleName").getValue(String.class).equals(mCurrentVehicleName) && snapshot.child("City").getValue(String.class).equals(mCurrentCity)) {
                                    ...
                                    DatabaseReference removeFavourites = FirebaseDatabase.getInstance().getReference("Users/" + FirstRunSecondActivity.userUid + "/Favourites/" + favouritesUid);
