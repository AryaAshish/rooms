...
public class HotelActivity_1 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HotelAdapter.content == "Bookings"){
            ...
            DatabaseReference locationReference = FirebaseDatabase.getInstance().getReference("Users/" + FirstRunSecondActivity.userUid + "/Bookings");
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                DatabaseReference favouritesReference = FirebaseDatabase.getInstance().getReference("Users/" + FirstRunSecondActivity.userUid);
