...
public class Constants {
    ...
    public static final String M_ID = "ZyfQBw80784115106624"; //Paytm Merchand Id we got it in paytm credentials
   ...
   // public static final String CALLBACK_URL = "https://pguat.paytm.com/paytmchecksum/paytmCallback.jsp";//doubtError1
